...
> ${config.voteManager.vote_url}`);
          ...
          case "playlistModal":
            {
              ...
              if (
                ...
                return interaction
                  ?.reply({ content: `${lang.msg10}`, ephemeral: true })
                  .catch((e) => {});
              ...
              if (!music_filter?.length > 0) {
                ...
                return interaction
                  ?.reply({
                    content: `<@${interaction?.user?.id}>, **${queue?.songs[0]?.name}** ${lang.msg12}`,
                    ephemeral: true,
                  })
                  .catch((e) => {});
              } else {
                return interaction
                  ?.reply({
                    content: `<@${interaction?.user?.id}>, **${queue?.songs[0]?.name}** ${lang.msg104}`,
                    ephemeral: true,
                  })
                  .catch((e) => {});
              }
    ...
    return interaction
      ?.reply({ content: `${lang?.error7}`, ephemeral: true })
      .catch((e) => {});
  }
};
