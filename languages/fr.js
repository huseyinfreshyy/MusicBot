const language = {
  ...
  error1:
    "Le jeton de bot que vous avez entré dans votre projet est incorrect ou les intentions de votre bot sont désactivées!",
  error2:
    "Veuillez définir le jeton du bot dans token.js ou dans votre fichier .env dans votre projet!",
  loadclientevent: "Événement client chargé",
  embed1:
    "Vous devez avoir le rôle <@&{djRole}>(DJ) défini sur ce serveur pour utiliser cette commande. Les utilisateurs sans ce rôle ne peuvent pas utiliser le {cmdMAP}",
  ...
  error4:
    "AVERTISSEMENT : Il semble que vous n'ayez pas écrit l'URL mongodb? Si vous n'entrez pas une URL mongodb valide dans le fichier config.js, vous ne pourrez pas utiliser le bot.",
  msg13: `🎵 En cours de lecture: **{track?.title}** -> Chaîne: **{queue?.connection.channel.name}** 🎧`,
  msg14:
    "La file d'attente est vide. Vous pouvez jouer un peu plus de musique, au revoir... ✅",
  msg15: "Je me suis déconnecté car il n'y a plus personne sur ma chaîne. ❌",
  msg16:
    "Je n'arrive pas à me connecter au canal vocal. ❌ Comme si quelqu'un m'avait déconnecté? Je suis très triste. 😔",
  ...
  msg26:
    "Si vous ne spécifiez pas de rôle DJ, vous ne pourrez pas utiliser la commande!",
  ...
  msg32:
    "Il est temps d'écouter de la musique sur votre serveur Discord avec une interface entièrement gratuite et avancée. Un bot musical qui prend en charge la lecture de musique sur de nombreuses plates-formes, ce qui rendra votre serveur spécial.\nhttps://discord.gg/ZcDprCrFTn",
  ...
  msg110:
    "Écrivez le nom de la liste de lecture que vous souhaitez rechercher. ❌",
  ...
  msg118:
    "Votre temps est écoulé pour utiliser cette commande, vous pouvez taper `/playlist list {name}` pour utiliser à nouveau la commande.",
  msg119:
    "Utilisez la commande **/play playlist <list-name>** pour écouter ces playlists.\nTapez **/playlist list <list-name>** pour voir la musique dans une liste.",
  msg120: "Veuillez spécifier un canal de texte.",
  msg121:
    "<#{channel}> ajouté à la liste des canaux d'utilisation de la commande, la commande bot ne peut désormais être utilisée que sur les canaux de la liste.",
  msg122: "Aucune donnée n'est déjà enregistrée.",
  msg123:
    "<#{channel}> supprimé de la liste des canaux d'utilisation de la commande.",
  msg124:
    "Ce canal est déjà sur la liste des canaux d'utilisation de la commande.",
  msg125: "Ce canal n'est pas un canal texte.",
  msg126:
    "❌ Voici la liste des canaux que vous pouvez commander sur ce serveur: {channel_filter}",
  msg127: "La commande n'est pas définie.",
  error7:
    "Veuillez réessayer cette commande plus tard. Possible bug signalé aux développeurs de robots.",
  msg128:
    "Vous m'avez fait taire pendant que la musique jouait. C'est pourquoi j'ai arrêté la musique. Si vous annulez le son, je continuerai. 😔",
  msg129: "joue",
  msg130: "Veuillez écrire un nombre valide.",
  msg131:
    "pour utiliser les commandes de la liste, vous devez voter pour le bot.",
  ...
  msg135:
    "Le temps de lecture a été défini avec succès sur {queue.formattedCurrentTime}",
