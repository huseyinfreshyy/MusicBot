const language = {
  ...
  error1:
    "De Bot Token die je in je project hebt ingevoerd is onjuist of de 'Intents' van je Bot zijn UIT!",
  error2:
    "Stel de bot token in token.js of in je .env bestand in voor jou project!",
  loadclientevent: "Client event geladen",
  embed1:
    "Je moet de <@&{djRole}>(DJ) rol op deze server hebben ingesteld om dit commando te kunnen gebruiken. Gebruikers zonder deze rol kunnen de {cmdMAP} niet gebruiken",
  ...
  error4:
    "WAARSCHUWING: Het ziet er naar uit dat je geen MongoDB URL hebt geschreven? Als je geen geldige mongodb url invult in het config.js bestand, zal je de bot niet kunnen gebruiken.",
  ...
  msg15:
    "Ik heb de verbinding verbroken omdat er niemand meer in mijn kanaal is. ❌",
  msg16:
    "Ik heb problemen om verbinding te maken met het stem kanaal. Alsof iemand mijn verbinding verbroken heeft? Ik ben erg verdrietig. 😔",
  ...
  msg26:
    "Als je geen DJ rol specificeert, zul je het commando niet kunnen gebruiken!",
  ...
  msg32:
    "Het is tijd om naar muziek te luisteren op je discord server met een volledig gratis en geavanceerde interface. Muziek bot die het afspelen van muziek op vele platformen ondersteunt die je server een speciaal gevoel zal geven. Maak je eigen muziek bot: https://github.com/umutxyp/MusicBot",
  msg33: "Bot Commandos",
  ...
  msg118:
    "Je tijd om dit commando te gebruiken is verstreken, je kan `/playlist list {name}` typen om het commando opnieuw te gebruiken.",
  msg119:
    "Gebruik het commando **/play playlist <list-name>** om deze afspeellijsten te beluisteren.\nTyp **/playlist list <list-name>** om de muziek in een lijst te zien.",
  msg120: "Gelieve een tekstkanaal te specificeren.",
  msg121:
    "<#{channel}> toegevoegd aan de lijst met kanalen voor het gebruik van commando's, nu kan het bot-commando alleen worden gebruikt op de kanalen in de lijst.",
  ...
  msg126:
    "❌ Hier is een lijst van kanalen waar je de commandos kunt gebruiken: {channel_filter}",
  msg127: "Commando niet gedefinieert.",
  error7:
    "Probeer deze command later opnieuw. Mogelijke bug gemeld aan botontwikkelaars.",
  msg128:
    "Je mute me terwijl de muziek speelde. Daarom ben ik gestopt met de muziek. Als je me unmute ga ik verder. 😔",
  msg129: "Spelen",
  msg130: "Schrijf A.U.B een geldig nummer.",
  msg131:
    "om de opdrachten in de lijst te gebruiken, moet je op de bot stemmen.",
  ...
  msg136:
    "Automatisch afspelen is nu ingeschakeld. Ik ga vanaf nu willekeurige muziek aanzetten.",
