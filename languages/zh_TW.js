const language = {
  ...
  embed1:
    "您必須有 <@&{djRole}>(DJ) 身分組以使用這項指令，用戶沒有此身分組無法使用 {cmdMAP}",
  message1: "您沒有連線至語音頻道。 ❌",
  ...
  error4:
    "警告: It looks like you didn't write the mongodb url? If you do not enter a valid mongodb url in the config.js file, you will not be able to use the bot.",
  ...
  msg32:
    "是時候嘗試這個完全免費的Discord音樂機器人了，快到 https://github.com/umutxyp/MusicBot 設置自己的機器人吧！",
  msg33: "指令",
  msg34: "您已經輸入過這個指令了。 ❌",
  msg35: "佇列",
  msg36: "目前播放",
  ...
  msg88: `現在已經是這個音量了。 ❌`,
  msg89: `**輸入一個介於 \`1\` to \`{maxVol}\` 的數字以調整音量。** ❌`,
  msg90: "音量調整:",
  msg91: `幫這個播放清單取個名字吧。 ❌`,
  msg92: `已經存在這個名稱的播放清單。 ❌`,
  ...
  msg117: `您沒有任何播放清單。❌`,
  msg118:
    "反應時間已經超過，您可以輸入 `/playlist list {name}` 重新使用這些指令。",
  msg119:
    "使用 **/play playlist <list-name>** 指令來聽這些播放清單。\n輸入 **/playlist list <list-name>** 來看看清單中有什麼歌。",
  msg120: "請指定一個文字頻道。",
